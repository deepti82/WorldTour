...
class BucketListTableViewController: UITableViewController  {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if whichView == "BucketList" {
            ...
            cell.countryPicture.sd_setImage(with: (getImageURL(bucket[indexPath.row]["countryCoverPhoto"].stringValue,width: BIG_PHOTO_WIDTH)), placeholderImage: getPlaceholderImage())
            ...
            cell.countryPicture.sd_setImage(with: (getImageURL(self.result[indexPath.section]["countries"][indexPath.row]["countryId"]["countryCoverPhoto"].stringValue,width: BIG_PHOTO_WIDTH)), placeholderImage: getPlaceholderImage())
            cell.countryPicture.alpha = 1
