...
//                cell.bgImage.transform = CGAffineTransform(rotationAngle: 0.0349066)
                ...
                cell.coverImage.hnk_setImageFromURL(getImageURL(allData[indexPath.section]["data"][indexPath.row]["name"].stringValue, width: 300))
                cell.bgImage.hnk_setImageFromURL(getImageURL(allData[indexPath.section]["data"][indexPath.row]["name"].stringValue, width: 300))
                cell.albumTitle.attributedText = createHeaderDate(currDate: allData[indexPath.row]["UTCModified"].stringValue, count: allData[indexPath.row]["count"].stringValue)
