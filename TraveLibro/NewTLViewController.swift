...
//        rightButton1.imageView?.tintColor = UIColor(hex: "#11d3cb")
        ...
        rightButton2.frame = CGRect(x: 40, y: 10, width: 30, height: 20)
...
//        transparentOrangeButton(self.addPostsButton)
        ...
        self.mainFooter = FooterViewNew(frame: CGRect(x: 0, y: self.view.frame.height - 64, width: self.view.frame.width, height: 64))
